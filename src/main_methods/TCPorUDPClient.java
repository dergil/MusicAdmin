...
//                cliAdmin.start();
    ...
    private static String checkProtocol(String input){
        if (input.equals("TCP"))
            return input;
    ...
    private static void start(CLIAdminForNet cliAdmin) throws IOException {
        boolean success = false;
        do {
            success = cliAdmin.start();
        } while (!success);
    }
}
