...
public class AddLicensedVideoController {
    ...
    public AddLicensedVideoController(EventFactory eventFactory, EventHandler eventHandler, MediaFileRepository mediaFileRepository, ListView<String> listView) {
    ...
    public void onActionEvent(ActionEvent actionEvent) {
        Stage stage = (Stage) holderTextField.getScene().getWindow();
        try {
            String[] input = new String[10];
            input[0] = MediaTypes.LICENSEDVIDEO.toString();
            ...
            input[8] = holderTextField.getText();
            LicensedVideoEvent event = eventFactory.licensedVideoEvent(input);
