...
public class AddLicensedAudioController {
    ...
    public AddLicensedAudioController(EventFactory eventFactory, EventHandler eventHandler, MediaFileRepository mediaFileRepository, ListView<String> listView) {
    ...
    public void onActionEvent(ActionEvent actionEvent) {
        ...
        try {
            ...
            input[0] = MediaTypes.LICENSEDAUDIO.toString();
            ...
            input[7] = holderTextField.getText();
            LicensedAudioEvent event = eventFactory.licensedAudioEvent(input);
