...
public class AddAudioVideoController {
    ...
    public AddAudioVideoController(EventFactory eventFactory, EventHandler eventHandler, MediaFileRepository mediaFileRepository, ListView<String> listView) {
    ...
    public void onActionEvent(ActionEvent actionEvent) {
        ...
        try {
            ...
            input[0] = MediaTypes.AUDIOVIDEO.toString();
            ...
            AudioVideoEvent event = eventFactory.audioVideoEvent(input);
