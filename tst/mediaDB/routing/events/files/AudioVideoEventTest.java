...
class AudioVideoEventTest {
    ...
    String fileType = MediaTypes.AUDIOVIDEO.toString();
    String eventName = fileType + "Event";
    AudioVideoEvent event = new AudioVideoEvent(this, fileType, samplingRate, width, height, encoding, tags, bitrate, length, uploader, sender);
