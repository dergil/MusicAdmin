...
class LicensedVideoEventTest {
    ...
    LicensedVideoEvent event = new LicensedVideoEvent(this, fileType, width, height, encoding, tags, holder, bitrate, length, uploader, sender);
