...
class LicensedAudioVideoEventTest {
    ...
    LicensedAudioVideoEvent event = new LicensedAudioVideoEvent(this, fileType, samplingRate, width, height, encoding, holder, bitrate, length, tags, uploader, sender);
